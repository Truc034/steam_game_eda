# -*- coding: utf-8 -*-
"""Final_Steam_dataset_Cleaning_and_EDA.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1EyJIUF-sephdBsLkWzJCvMFNhQa3Bxum
...
* **Value is the top success multiplier** (**r = 0.90**)
* **Scale and player advocacy** drive momentum
* **Highly concentrated market** Few hit games dominate key metrics
* **Review scores follow success**: Focus on player satisfaction, not review optimization
